...
export const maxActiveFishPerTank = 5;
...
export const tankSideDockTopY = 138;
export const tankMenuButtonY = tankSideDockTopY;
export const foodDockTopBelowMenu = tankSideDockTopY;
export const overfullHungerFloor = 0;
...
export const coinMagnetRayYOffset = 0;
