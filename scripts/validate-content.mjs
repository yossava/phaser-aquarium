...
const foodTypes = new Set(["micro", "basic", "basicMedium", "basicLarge", "basicXL", "premium", "herb", "protein", "coral", "medicine", "ageBoost", "productionBoost", "timeCurrent", "creature", "event"]);
